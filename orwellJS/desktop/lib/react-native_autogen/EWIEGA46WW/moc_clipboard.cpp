...
#include <memory>
#include "../../../../node_modules/react-native/ReactQt/runtime/src/clipboard.h"
...
QT_MOC_LITERAL(1, 10, 9), // "getString"
QT_MOC_LITERAL(2, 20, 13), // "REACT_PROMISE"
QT_MOC_LITERAL(3, 34, 34), // "ModuleInterface::ListArgument..."
QT_MOC_LITERAL(4, 69, 7), // "resolve"
QT_MOC_LITERAL(5, 77, 6), // "reject"
QT_MOC_LITERAL(6, 84, 9), // "setString"
QT_MOC_LITERAL(7, 94, 0), // ""
QT_MOC_LITERAL(8, 95, 16) // "clipboardContent"

    },
    "Clipboard\0getString\0REACT_PROMISE\0"
    "ModuleInterface::ListArgumentBlock\0"
    "resolve\0reject\0setString\0\0clipboardContent"
};
...
void Clipboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getString((*reinterpret_cast< const ModuleInterface::ListArgumentBlock(*)>(_a[1])),(*reinterpret_cast< const ModuleInterface::ListArgumentBlock(*)>(_a[2]))); break;
