...
#include <memory>
#include "../../../../node_modules/react-native/ReactQt/runtime/src/testmodule.h"
...
QT_MOC_LITERAL(1, 11, 13), // "testCompleted"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 17) // "markTestCompleted"

    },
    "TestModule\0testCompleted\0\0markTestCompleted"
};
...
void TestModule::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TestModule *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->testCompleted(); break;
        case 1: _t->markTestCompleted(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TestModule::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TestModule::testCompleted)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TestModule::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_TestModule.data,
    qt_meta_data_TestModule,
    qt_static_metacall,
    nullptr,
    nullptr
} };
