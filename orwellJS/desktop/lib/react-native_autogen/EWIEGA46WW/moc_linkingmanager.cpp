...
static const uint qt_meta_data_LinkingManager[] = {
 ...
 // methods: name, argc, parameters, tag, flags
       1,    3,   29,    2, 0x00 /* Private */,
       7,    3,   36,    2, 0x00 /* Private */,
       8,    2,   43,    2, 0x00 /* Private */,
...
void LinkingManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LinkingManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 2: _t->getInitialURL((*reinterpret_cast< const ModuleInterface::ListArgumentBlock(*)>(_a[1])),(*reinterpret_cast< const ModuleInterface::ListArgumentBlock(*)>(_a[2]))); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject LinkingManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_LinkingManager.data,
    qt_meta_data_LinkingManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
