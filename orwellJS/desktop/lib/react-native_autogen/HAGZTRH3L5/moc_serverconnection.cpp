...
QT_INIT_METAOBJECT const QMetaObject LocalServerConnection::staticMetaObject = { {
    ...
    qt_meta_stringdata_LocalServerConnection.data,
    qt_meta_data_LocalServerConnection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject RemoteServerConnection::staticMetaObject = { {
    &ServerConnection::staticMetaObject,
    qt_meta_stringdata_RemoteServerConnection.data,
    qt_meta_data_RemoteServerConnection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
