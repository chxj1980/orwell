...
#include <memory>
#include "../../../../node_modules/react-native/ReactQt/runtime/src/componentmanagers/modalmanager.h"
...
void ModalManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ModalManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ModalManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ModalManager.data,
    qt_meta_data_ModalManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
