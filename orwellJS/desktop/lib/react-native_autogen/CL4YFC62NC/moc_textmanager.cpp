...
#include "../../../../../react-native-desktop/ReactQt/runtime/src/componentmanagers/textmanager.h"
...
QT_MOC_LITERAL(1, 12, 19), // "nestedPropertyValue"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 11), // "QQuickItem*"
QT_MOC_LITERAL(4, 45, 4), // "item"
QT_MOC_LITERAL(5, 50, 12), // "propertyName"
QT_MOC_LITERAL(6, 63, 21), // "updateMeasureFunction"
QT_MOC_LITERAL(7, 85, 8), // "textItem"
QT_MOC_LITERAL(8, 94, 6), // "escape"
QT_MOC_LITERAL(9, 101, 4) // "text"

    },
    "TextManager\0nestedPropertyValue\0\0"
    "QQuickItem*\0item\0propertyName\0"
    "updateMeasureFunction\0textItem\0escape\0"
    "text"
};
...
static const uint qt_meta_data_TextManager[] = {
 ...
 // slots: parameters
    QMetaType::QVariant, 0x80000000 | 3, QMetaType::QString,    4,    5,
...
void TextManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateMeasureFunction((*reinterpret_cast< QQuickItem*(*)>(_a[1]))); break;
        case 2: { QString _r = _t->escape((*reinterpret_cast< const QString(*)>(_a[1])));
...
void *TextManager::qt_metacast(const char *_clname)
{
    ...
    return RawTextManager::qt_metacast(_clname);
}

int TextManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = RawTextManager::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
