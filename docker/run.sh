...
INSERT_LOCAL=
xhost local:root && sudo docker run --rm -it -v /tmp/.X11-unix:/tmp/.X11-unix -v /home/$USER_/orwell:/home/dev/orwell $(echo $INSERT_LOCAL) -e DISPLAY=unix$DISPLAY orwell && xhost -
